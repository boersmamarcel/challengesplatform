...
describe Follow do
  ...
  it "should delete all follow relations if an user deletes there account" do
    user_one = User.create(:email => 'user1@student.utwente.nl', :password => 'blaat123456', :password_confirmation => 'blaat123456')
    user_two = User.create(:email => 'user2@student.utwente.nl', :password => 'blaat123456', :password_confirmation => 'blaat123456')
