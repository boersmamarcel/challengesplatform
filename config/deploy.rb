...
role :web, "www.sciencechallenges.nl"                          # Your HTTP server, Apache/etc
role :app, "www.sciencechallenges.nl"                          # This may be the same as your `Web` server
role :db, "www.sciencechallenges.nl", :primary => true         # This may be the same as your `Web` server
