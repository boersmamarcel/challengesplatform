Feature: A dashboard for participant
  ...
  Scenario: View my active Challenges
    ...
    When I visit the "dashboard" page
    Then I should see "Norvig Award" in list "My Current Challenges"
    And I should not see "Shark hunting" in list "My Current Challenges"
    And I should not see "Norvig Award" in list "Upcoming Challenges"
  ...
  Scenario: View activities of friends
    ...
    When I visit the "dashboard" page
    Then I should see "Peter and Rick enrolled for the Innovate Education challenge" in list "Activity"
      And I should see "Joyce enrolled for the Save the World challenge" in list "Activity"
      And I should see "Rick unenrolled for the Innovate Education challenge" in list "Activity"
